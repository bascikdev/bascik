...
| :---: | :--- | :--- | :--- | :--- |
| [ ] | **HTML Parsing & Tokenization** | WHATWG HTML §13 | [`wpt.live/html/syntax/parsing/`](https://wpt.live/html/syntax/parsing/) | `components.ts`, `html-minifier.ts` (Void tags, rawtext) |
| [ ] | **HTML Elements & Grouping** | WHATWG HTML §4 | [`wpt.live/html/semantics/`](https://wpt.live/html/semantics/) | `components.ts` (Native element collision checks) |
| [ ] | **HTML Template Element (`<template>`)** | WHATWG HTML §4.12 | [`wpt.live/html/semantics/scripting-1/the-template-element/`](https://wpt.live/html/semantics/scripting-1/the-template-element/) | `slots.ts`, `components.ts` (Inert template fragments) |
| [ ] | **Custom Elements Lifecycle** | W3C / WHATWG HTML | [`wpt.live/custom-elements/`](https://wpt.live/custom-elements/) | `components.ts` (Hyphenated custom element naming) |
| [ ] | **Scoped Custom Registries** | W3C Web Incubator | [`wpt.live/custom-elements/scoped-registry/`](https://wpt.live/custom-elements/scoped-registry/) | `components.ts` (Build-time scoping isolation) |
| [ ] | **Shadow DOM & Slot Distribution** | WHATWG DOM §4 | [`wpt.live/shadow-dom/`](https://wpt.live/shadow-dom/) | `components.ts`, `slots.ts` (Named & default slots) |
| [ ] | **DOM Living Standard Core** | WHATWG DOM §4 | [`wpt.live/dom/`](https://wpt.live/dom/) | `scripts.ts`, `components.ts` (Tree mutation APIs) |
| [ ] | **DOM Level 1–3 Core & HTML** | W3C DOM Recommendations | [`W3C DOM Conformance Portal`](https://www.w3.org/DOM/Test/) | `scripts.ts` (Namespace methods, node traversal) |
| [ ] | **HTML Forms & Validation** | WHATWG HTML §4.10 | [`wpt.live/html/semantics/forms/`](https://wpt.live/html/semantics/forms/) | `components.ts` (Form controls & attributes) |
| [ ] | **HTML Interactive (`<dialog>`, `<details>`)** | WHATWG HTML §4.11 | [`wpt.live/html/semantics/interactive-elements/`](https://wpt.live/html/semantics/interactive-elements/) | `components.ts` (Popover, dialog expansion) |
| [ ] | **HTML Script Execution Model** | WHATWG HTML §8 | [`wpt.live/html/webappapis/scripting/`](https://wpt.live/html/webappapis/scripting/) | `scripts.ts` (`async`, `defer`, module loading) |
| [ ] | **HTML Canvas 2D** | WHATWG HTML §4.12 | [`wpt.live/html/canvas/`](https://wpt.live/html/canvas/) | `components.ts` (Canvas attribute preservation) |
| [ ] | **W3C HTML 4.01 (Historical)** | W3C Recommendation | [`W3C HTML 4.01 Index`](https://www.w3.org/MarkUp/Test/HTML401/current/) | `components.ts` (Nesting baseline & DTD rules) |
| [ ] | **W3C XHTML-Print (Historical)** | W3C Recommendation | [`W3C XHTML-Print Index`](https://www.w3.org/MarkUp/Test/xhtml-print/current/) | `components.ts` (Print markup semantics) |
| [ ] | **W3C UAAG 1.0 Accessibility** | W3C WAI Guideline | [`W3C UAAG HTML Suite`](https://www.w3.org/WAI/UA/TS/html401/) | `components.ts` (ARIA, `alt`, `label` accessibility) |
...
- [ ] **HTML Parsing & Syntax Tokenization**
...
- [ ] **HTML Template Element (`<template>`) & DocumentFragment**
...
- [ ] **HTML Interactive Elements (`<dialog>`, `<details>`, Popovers)**
...
- [ ] **HTML Web Application Scripting & Execution Model**
...
- [ ] **Shadow DOM Encapsulation & Slot Distribution**
...
- [ ] **W3C DOM Level 1, 2, 3 Conformance Suites**
...
- [ ] **Modern DOM Living Standard Tests (WPT)**
...
- [ ] **W3C HTML 4.01 Test Suite (20030123)**
...
- [ ] **W3C XHTML-Print Test Suite (20040426)**
...
- [ ] **W3C User Agent Accessibility Guidelines (UAAG 1.0) HTML Suite**
