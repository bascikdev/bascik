...
| **Resolution Status** | ⏳ **In Progress / Baseline Catalog Established** |
...
| :---: | :--- | :--- | :--- | :--- |
| [ ] | **CSS2 (Core / Errata)** | §2.1 Official Definition | [`CSS2.1 20110323`](https://www.w3.org/Style/CSS/Test/CSS2.1/20110323/) / [`Latest`](http://test.csswg.org/suites/css2.1/latest/) | `styles.ts` (Syntax, specificity, cascade) |
| [ ] | **CSS Syntax 3** | §2.1 Official Definition | [`wpt.live/css/css-syntax/`](https://wpt.live/css/css-syntax/) | `styles.ts` (Tokenizer, parser, comments) |
| [ ] | **CSS Style Attributes** | §2.1 Official Definition | [`wpt.live/css/css-style-attr/`](https://wpt.live/css/css-style-attr/) | `components.ts` (`style=""` attribute parsing) |
| [ ] | **Media Queries 3** | §2.1 Official Definition | [`Self-Contained Suite`](https://www.w3.org/Style/CSS/Test/MediaQueries/20120229/test_media_queries.html) | `styles.ts` (`@media` preserving & scoping) |
| [ ] | **CSS Conditional Rules 3** | §2.1 Official Definition | [`wpt.live/css/css-conditional/`](https://wpt.live/css/css-conditional/) | `styles.ts` (`@supports` feature queries) |
| [ ] | **Selectors 3** | §2.1 Official Definition | [`CSS3 Selectors Index`](https://www.w3.org/Style/CSS/Test/CSS3/Selectors/current/) | `styles.ts` (Selector conversion & prefixes) |
| [ ] | **CSS Namespaces** | §2.1 Official Definition | [`CSS3 Namespace Index`](https://www.w3.org/Style/CSS/Test/CSS3/Namespace/current/) | `styles.ts` (`@namespace` declaration handling) |
| [ ] | **CSS Cascade 4** | §2.1 Official Definition | [`wpt.live/css/css-cascade/`](https://wpt.live/css/css-cascade/) | `styles.ts` (Specificity calculation & `all`) |
| [ ] | **CSS Values & Units 3** | §2.1 Official Definition | [`wpt.live/css/css-values/`](https://wpt.live/css/css-values/) | `styles.ts` (`calc()`, units, `url()` shielding) |
| [ ] | **CSS Custom Properties 1** | §2.1 Official Definition | [`wpt.live/css/css-variables/`](https://wpt.live/css/css-variables/) | `styles.ts` (`--prop`, `var()` scoping) |
| [ ] | **CSS Color 4** | §2.1 Official Definition | [`wpt.live/css/css-color/`](https://wpt.live/css/css-color/) | `css-minifier.ts`, `styles.ts` (Hex & spaces) |
| [ ] | **CSS Box Model 3** | §2.1 Official Definition | [`wpt.live/css/css-box/`](https://wpt.live/css/css-box/) | `styles.ts` (Box sizing & geometry) |
| [ ] | **CSS Backgrounds 3** | §2.1 Official Definition | [`wpt.live/css/css-backgrounds/`](https://wpt.live/css/css-backgrounds/) | `styles.ts` (`background`, `border-radius`) |
| [ ] | **CSS Images 3** | §2.1 Official Definition | [`wpt.live/css/css-images/`](https://wpt.live/css/css-images/) | `styles.ts` (Gradients, `image-set()`) |
| [ ] | **CSS Fonts 3** | §2.1 Official Definition | [`wpt.live/css/css-fonts/`](https://wpt.live/css/css-fonts/) | `styles.ts` (`@font-face` preservation) |
| [ ] | **CSS Writing Modes 3** | §2.1 Official Definition | [`wpt.live/css/css-writing-modes/`](https://wpt.live/css/css-writing-modes/) | `styles.ts` (Directionality & orientation) |
| [ ] | **CSS Multi-column 1** | §2.1 Official Definition | [`wpt.live/css/css-multicol/`](https://wpt.live/css/css-multicol/) | `styles.ts` (`columns`, `column-span`) |
| [ ] | **CSS Flexbox 1** | §2.1 Official Definition | [`wpt.live/css/css-flexbox/`](https://wpt.live/css/css-flexbox/) | `styles.ts` (Flex alignment properties) |
| [ ] | **CSS Basic UI 3** | §2.1 Official Definition | [`wpt.live/css/css-ui/`](https://wpt.live/css/css-ui/) | `styles.ts` (`box-sizing`, `outline-offset`) |
| [ ] | **CSS Containment 1** | §2.1 Official Definition | [`wpt.live/css/css-contain/`](https://wpt.live/css/css-contain/) | `styles.ts` (`contain` property isolation) |
| [ ] | **CSS Transforms 1** | §2.1 Official Definition | [`wpt.live/css/css-transforms/`](https://wpt.live/css/css-transforms/) | `styles.ts` (2D transforms, transform-origin) |
| [ ] | **Compositing & Blending 1** | §2.1 Official Definition | [`wpt.live/css/compositing/`](https://wpt.live/css/compositing/) | `styles.ts` (`mix-blend-mode`, `isolation`) |
| [ ] | **CSS Easing Functions 1** | §2.1 Official Definition | [`wpt.live/css/css-easing/`](https://wpt.live/css/css-easing/) | `styles.ts` (`cubic-bezier()`, `steps()`) |
| [ ] | **CSS Counter Styles 3** | §2.1 Official Definition | [`wpt.live/css/css-counter-styles/`](https://wpt.live/css/css-counter-styles/) | `styles.ts` (`@counter-style` scoping) |
| [ ] | **Media Queries 4** | §2.2 Candidate Rec | [`wpt.live/css/mediaqueries/`](https://wpt.live/css/mediaqueries/) | `styles.ts` (Range syntax `<= 800px`) |
| [ ] | **CSS Grid Layout 1 & 2** | §2.2 Candidate Rec | [`wpt.live/css/css-grid/`](https://wpt.live/css/css-grid/) | `styles.ts` (Grid areas, subgrid) |
| [ ] | **CSS Cascade Layers 5** | §2.2 Candidate Rec | [`wpt.live/css/css-cascade/`](https://wpt.live/css/css-cascade/) | `styles.ts` (`@layer` name scoping) |
| [ ] | **CSS Scroll Snap 1** | §2.2 Candidate Rec | [`wpt.live/css/css-scroll-snap/`](https://wpt.live/css/css-scroll-snap/) | `styles.ts` (`scroll-snap-type`) |
| [ ] | **CSS Scrollbars Styling 1** | §2.2 Candidate Rec | [`wpt.live/css/css-scrollbars/`](https://wpt.live/css/css-scrollbars/) | `styles.ts` (`scrollbar-color`, `scrollbar-width`) |
| [ ] | **CSS Color Adjustment 1** | §2.2 Candidate Rec | [`wpt.live/css/css-color-adjust/`](https://wpt.live/css/css-color-adjust/) | `styles.ts` (`color-scheme` properties) |
| [ ] | **CSS Conditional Rules 4** | §2.2 Candidate Rec | [`wpt.live/css/css-conditional/`](https://wpt.live/css/css-conditional/) | `styles.ts` (`@supports selector(...)`) |
| [ ] | **CSS Display 3** | §2.3 Fairly Stable | [`wpt.live/css/css-display/`](https://wpt.live/css/css-display/) | `styles.ts` (Multi-keyword display syntax) |
| [ ] | **CSS Box Alignment 3** | §2.3 Fairly Stable | [`wpt.live/css/css-align/`](https://wpt.live/css/css-align/) | `styles.ts` (`gap`, `justify-self`, `align-content`) |
| [ ] | **CSS Fragmentation 3** | §2.3 Fairly Stable | [`wpt.live/css/css-break/`](https://wpt.live/css/css-break/) | `styles.ts` (`break-before`, `break-inside`) |
| [ ] | **CSS Shapes 1** | §2.3 Fairly Stable | [`wpt.live/css/css-shapes/`](https://wpt.live/css/css-shapes/) | `styles.ts` (`shape-outside`, basic shapes) |
| [ ] | **CSS Text 3** | §2.3 Fairly Stable | [`wpt.live/css/css-text/`](https://wpt.live/css/css-text/) | `styles.ts` (Word breaks, text wrapping) |
| [ ] | **CSS Text Decoration 3** | §2.3 Fairly Stable | [`wpt.live/css/css-text-decor/`](https://wpt.live/css/css-text-decor/) | `styles.ts` (`text-decoration-thickness`, `text-shadow`) |
| [ ] | **CSS Masking 1** | §2.3 Fairly Stable | [`wpt.live/css/css-masking/`](https://wpt.live/css/css-masking/) | `styles.ts` (`clip-path`, `mask-image`) |
| [ ] | **CSS View Transitions 1** | §2.3 Fairly Stable | [`wpt.live/css/css-view-transitions/`](https://wpt.live/css/css-view-transitions/) | `styles.ts` (`view-transition-name` scoping) |
| [ ] | **CSS Nesting 1** | §2.4 Rough Interop | [`wpt.live/css/css-nesting/`](https://wpt.live/css/css-nesting/) | `styles.ts` (`&` and relaxed direct nesting) |
| [ ] | **Selectors 4** | §2.4 Rough Interop | [`wpt.live/css/selectors/`](https://wpt.live/css/selectors/) | `styles.ts` (`:has()`, `:is()`, `:where()`, `:focus-visible`) |
| [ ] | **CSS Transitions & Animations 1**| §2.4 Rough Interop | [`wpt.live/css/css-animations/`](https://wpt.live/css/css-animations/) | `styles.ts` (`@keyframes` animation scoping) |
| [ ] | **CSS Position 3 & Anchors** | §2.4 Rough Interop | [`wpt.live/css/css-position/`](https://wpt.live/css/css-position/) | `styles.ts` (`anchor-name`, `@position-try`) |
| [ ] | **CSS Logical Properties 1** | §2.4 Rough Interop | [`wpt.live/css/css-logical/`](https://wpt.live/css/css-logical/) | `styles.ts` (`inline-size`, `margin-inline`) |
| [ ] | **CSS Box Sizing 3** | §2.4 Rough Interop | [`wpt.live/css/css-sizing/`](https://wpt.live/css/css-sizing/) | `styles.ts` (`aspect-ratio`, intrinsic sizing) |
| [ ] | **Filter Effects 1** | §2.4 Rough Interop | [`wpt.live/css/filter-effects/`](https://wpt.live/css/filter-effects/) | `styles.ts` (`backdrop-filter`, `filter`) |
| [ ] | **CSSOM & CSSOM View** | §2.4 Rough Interop | [`wpt.live/css/cssom/`](https://wpt.live/css/cssom/) / [`View`](https://wpt.live/css/cssom-view/) | `scripts.ts` (DOM queries, `CSS.escape()`) |
| [ ] | **Resize Observer 1** | §2.4 Rough Interop | [`wpt.live/resize-observer/`](https://wpt.live/resize-observer/) | `scripts.ts` (Element resize observation) |
...
- [ ] **CSS Level 2 (Revision 1 / Errata) `[CSS2]`**
...
- [ ] **CSS Custom Properties Module Level 1 `[CSS-VARIABLES-1]`**
...
- [ ] **CSS Box Model 3 `[CSS-BOX-3]` & Backgrounds 3 `[CSS-BACKGROUNDS-3]`**
...
- [ ] **CSS Fonts 3 `[CSS-FONTS-3]` & Images 3 `[CSS-IMAGES-3]`**
...
- [ ] **CSS Multi-column 1, Flexbox 1, Basic UI 3 & Containment 1**
...
- [ ] **CSS Transforms 1, Compositing 1, Easing 1 & Counter Styles 3**
...
- [ ] **CSS Grid Layout Module Level 1 & 2 `[CSS-GRID-1, CSS-GRID-2]`**
...
- [ ] **CSS Cascade Layers 5 `[CSS-CASCADE-5]`**
...
- [ ] **CSS Scroll Snap 1, Scrollbars Styling 1, Color Adjustment 1 & Conditional 4**
...
- [ ] **CSS Display 3, Box Alignment 3, Fragmentation 3 & Shapes 1**
...
- [ ] **CSS Text 3, Text Decoration 3, Masking 1 & View Transitions 1**
...
- [ ] **CSS Transitions 1, Animations 1 & Position 3 (Anchor Positioning)**
...
- [ ] **CSS Logical Properties 1, Box Sizing 3, Filter Effects 1, CSSOM 1 & Resize Observer 1**
...
- [ ] **CSS Level 1 Test Suite (20070302 / Obsolete):** `https://www.w3.org/Style/CSS/Test/CSS1/current/`
- [ ] **CSS Mobile Profile 1.0:** `https://www.w3.org/Style/CSS/Test/Mobile/1.0/current/`
- [ ] **CSS Print Profile 1.0:** `https://www.w3.org/Style/CSS/Test/Print/1.0/current/`
- [ ] **CSS3 Paged Media (Pre-Alpha):** `https://www.w3.org/Style/CSS/Test/CSS3/Page/current/`
