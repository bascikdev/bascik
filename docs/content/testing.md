...
This allows testing Markdown parsers, navigation generators, and page-aware helpers (which read `BASCIK_TEMPLATE_FILE`, `BASCIK_PAGE_FILE`, `BASCIK_PAGES_DIR`, and `BASCIK_SITE_URL`) by mocking environment variables in Vitest:
...
describe('getCanonicalUrl', () => {
  ...
  it('computes correct canonical tag from page file path', () => {
    process.env.BASCIK_TEMPLATE_FILE = '/app/src/pages/about.html';
